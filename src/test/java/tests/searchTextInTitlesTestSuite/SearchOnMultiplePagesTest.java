...
public class SearchOnMultiplePagesTest extends BaseTest {
    ...
    /**
     * Checks whether the search words are present in the found persons titles, checks it on the pages that were
    ...
    public void checkThatSearchedTextIsPresentInTitle(String searchTerm, String expectedString) {
        ...
        Assert.assertTrue(searchPage.areSearchedWordsPresentInPersonsTitles(4, 8, expectedString));
